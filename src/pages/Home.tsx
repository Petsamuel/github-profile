...
import { NumberTicker } from "../components/Loader";
...
const Home = () => {
  ...
  return (
    <>
      {loading ? (
        <div className="text-4xl text-white font-bold p-2 text-center flex gap-2 justify-center items-center h-screen relative tracking-tighter">
          <NumberTicker
            value={99}
            className="  space-grotesk text-[20dvw] font-bold  text-gray-900"
          />
        </div>
      ) : (
        <>
