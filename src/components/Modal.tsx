      ...
      <Modal>
        ...
        <ModalBody>
          <>
              ...
              {!loading && roast ? (
                <div className="">
                  ...
                  <div className="font-sans ">
                    ...
                    <p className="text-sm text-slate-400 font-semibold mt-8 ">
                      Repository:&nbsp;{roast?.Repo}
                    </p>
                  </div>
                </div>
              ) : (
                <div className="text-4xl text-white font-bold p-2 text-center flex gap-2">
            ...
            {roast ? (
              <ModalFooter className="gap-4 hidden">
